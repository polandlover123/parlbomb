...
badd +1 .
badd +24 ~/parlbomb/home/programs/neovim/plugins/lsp.nix
argglobal
%argdel
$argadd .
edit ~/parlbomb/home/programs/neovim/plugins/lsp.nix
...
setlocal statuscolumn=
setlocal statusline=%#lualine_a_command#\ COMMAND\ %#lualine_transitional_lualine_a_command_to_lualine_b_normal#î‚°%#lualine_b_normal#\ î‚ \ master\ î‚±%#lualine_b_diagnostics_warn_command#\ ó°€ª\ 4\ %<%#lualine_c_normal#\ lsp.nix\ %#lualine_c_normal#%=%#lualine_x_filetype_DevIconNix_command#\ ïŒ“\ %#lualine_c_normal#nix\ %#lualine_b_normal#\ 27%%\ %#lualine_transitional_lualine_a_command_to_lualine_b_normal#î‚²%#lualine_a_command#\ ïº\ 02:23\ 
setlocal suffixesadd=
setlocal noswapfile
setlocal synmaxcol=3000
if &syntax != ''
